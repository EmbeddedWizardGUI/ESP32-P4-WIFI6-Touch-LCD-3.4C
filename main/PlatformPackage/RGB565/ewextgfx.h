...
/* ESP32 operates with premultiplied colors - but PPA expects non-premultiplied colors */
...
//  #define EwGfxFillSolidBlend         GfxFillDriver // blending with fill client not supported
  #define EwGfxScreenFillSolid        GfxFillDriver
//  #define EwGfxScreenFillSolidBlend   GfxFillDriver // blending with fill client not supported
#endif
...
//  #define EwGfxCopyAlpha8Solid            GfxCopyDriver // alpha8 with srm client not supported
//  #define EwGfxCopyRGB565                 GfxCopyDriver // can be done with blend driver faster<
  #define EwGfxCopyRGB565Solid            GfxCopyDriver
//  #define EwGfxScreenCopyNative           GfxCopyDriver // can be done with blend driver faster<
  #define EwGfxScreenCopyNativeSolid      GfxCopyDriver
//  #define EwGfxScreenCopyAlpha8Solid      GfxCopyDriver // alpha8 with srm client not supported
//  #define EwGfxScreenCopyRGB565           GfxCopyDriver // can be done with blend driver faster<
...
/* Macros to redirect the Graphics Engine operations to the above function. */
  ...
  #define EwGfxCopyRGB565                 GfxBlendDriver
  #define EwGfxScreenCopyNative           GfxBlendDriver
  #define EwGfxScreenCopyRGB565           GfxBlendDriver
