...
/* ******************************************************************************
   ...
   **************************************************************************** */
#define EW_PLATFORM_STRING    "ESP32-P4-WIFI6-Touch-LCD-3.4C"
...
#define RTC_DEFAULT_TIME      1765029600     /* 2025-12-06 15:00 */
...
/* ******************************************************************************
   ...
   Please note that changing this macro requires access to the complete
   Graphics Engine source code and recompilation. It will have no effect when
   using pre-compiled libraries.
   **************************************************************************** */
#define EW_USE_DOUBLE_BUFFER            1

#define EW_DISPLAY_WIDTH                800
#define EW_DISPLAY_HEIGHT               800

#define EW_FRAME_BUFFER_WIDTH           800
#define EW_FRAME_BUFFER_HEIGHT          800
...
#define EW_MEMORY_POOL_SIZE      0x800000
